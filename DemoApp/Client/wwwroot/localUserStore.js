(function () {
    ...
    const db = idb.openDB('Users', 1, {
        upgrade(db) {
            db.createObjectStore('metadata');
            db.createObjectStore('serverdata', { keyPath: 'id' }).createIndex('lastUpdated', 'lastUpdated');
            db.createObjectStore('localedits', { keyPath: 'id' });
        },
    });

    window.localUserStore = {
